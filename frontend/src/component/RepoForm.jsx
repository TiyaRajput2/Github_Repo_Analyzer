  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      <div className="space-y-2">
        ...
        <input
          className="w-full rounded-2xl border border-white/10 bg-slate-950/40 px-4 py-3 text-white placeholder:text-slate-400 shadow-inner shadow-black/30 outline-none ring-0 transition focus:border-cyan-400/60 focus:bg-slate-950/60 disabled:cursor-not-allowed disabled:opacity-60"
      ...
      <div className="space-y-2">
        ...
        <textarea
          className="min-h-32 w-full rounded-2xl border border-white/10 bg-slate-950/40 px-4 py-3 text-white placeholder:text-slate-400 shadow-inner shadow-black/30 outline-none transition focus:border-cyan-400/60 focus:bg-slate-950/60 disabled:cursor-not-allowed disabled:opacity-60"
